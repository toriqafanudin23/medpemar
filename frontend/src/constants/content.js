  ...
  volume: [
    {
      ...
      options: ['\\text{32 cm}^2', '\\text{64 cm}^2', '\\text{128 cm}^2', '\\text{256 cm}^2'],
      answer: 1,
    ...
    },
    {
      ...
      options: ['\\text{480.000 liter}', '\\text{320.000 liter}', '\\text{240.000 liter}', '\\text{180.000 liter}'],
      answer: 0,
    ...
    },
    {
      ...
      options: ['\\text{2 cm}', '\\text{3 cm}', '\\text{4 cm}', '\\text{5 cm}'],
      answer: 1,
    ...
    },
    {
      ...
      options: ['\\text{75 buah}', '\\text{100 buah}', '\\text{125 buah}', '\\text{150 buah}'],
      answer: 2,
    ...
    },
    {
      ...
      options: ['\\text{2 menit}', '\\text{3 menit}', '\\text{4 menit}', '\\text{5 menit}'],
      answer: 2,
  ...
  surface: [
    {
      ...
      options: ['\\text{276 cm}^2', '\\text{296 cm}^2', '\\text{316 cm}^2', '\\text{392 cm}^2'],
      answer: 1,
    ...
    },
    {
      ...
      options: ['\\text{Rp 64.000,00}', '\\text{Rp 72.000,00}', '\\text{Rp 80.000,00}', '\\text{Rp 92.000,00}'],
      answer: 1,
    ...
    },
    {
      ...
      options: ['\\text{10,5 cm}', '\\text{11,5 cm}', '\\text{12,5 cm}', '\\text{13,5 cm}'],
      answer: 2,
    ...
    },
    {
      ...
      options: ['\\text{4 kaleng}', '\\text{5 kaleng}', '\\text{6 kaleng}', '\\text{7 kaleng}'],
      answer: 2,
    ...
    },
    {
      ...
      options: ['\\text{5 gulungan}', '\\text{6 gulungan}', '\\text{7 gulungan}', '\\text{8 gulungan}'],
      answer: 1,
